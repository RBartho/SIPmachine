...
1. Download all files from this GitHub repository to your computer. (Download under green "Code" Button here: ![Back to mainpage](https://github.com/RBartho/SIPmachine/tree/main).)
